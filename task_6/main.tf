...
resource "null_resource" "build_and_push" {
  provisioner "local-exec" {
    command = <<EOT
        podman rmi -f ${azurerm_container_registry.acr.login_server}/flask-app:v1 || true
        cd /Users/pskaletskyy/Documents/Azure/Task_4/task_6/flask_app
        podman build -t ${azurerm_container_registry.acr.login_server}/flask-app:v1 .
        ...
        podman push ${azurerm_container_registry.acr.login_server}/flask-app:v1
    EOT
  }
